...
namespace ModbusMasterFramework
{
    class CRC16
    {
            ...
            public static byte[] getCrcByte(byte[] dataByte)
            {
                Console.WriteLine("Hello World!");
               // byte[] b = new byte[6] { 01, 03, 00, 01, 00, 02 };

                ushort crc = CRC16.calculateCRC(dataByte);
                //Console.WriteLine((crc & 65535).ToString("X2"));
                return BitConverter.GetBytes(crc);

            }
            public static ushort calculateCRC(byte[] dataByte)
            {
            ...
            public static UInt16[] CrcTable =
                {
            0x0, 0xC0C1, 0xC181, 0x140, 0xC301, 0x3C0,
               0x280, 0xC241, 0xC601, 0x6C0, 0x780, 0xC741,
               0x500, 0xC5C1, 0xC481, 0x440, 0xCC01, 0xCC0,
               0xD80, 0xCD41, 0xF00, 0xCFC1, 0xCE81, 0xE40,
               0xA00, 0xCAC1, 0xCB81, 0xB40, 0xC901, 0x9C0,
               0x880, 0xC841, 0xD801, 0x18C0, 0x1980, 0xD941,
